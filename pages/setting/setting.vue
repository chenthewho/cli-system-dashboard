<template>
  <div class="setting-container">
    <scroll-view scroll-y :style="{ height: WindowHeight + 'px' }">
      ...
      <div class="setting-section">
        ...
        <div class="settings-grid">
          ...
          <div class="setting-card" @click="showVersionModal">
            <div class="card-icon">
      ...
      <div class="znj-extra-modal" @click.stop>
        <div class="znj-extra-modal-header">
          ...
          <uni-icons
            ...
            type="icon-icon-cross-squre"
            size="32"
            @click="isExtraModalVisible = false"
            color="#ffffff"
            class="znj-modal-close"
          ></uni-icons>
        </div>
          ...
          <scroll-view scroll-y="true" class="unit-scroll-view">
            ...
            <div class="add-unit-section">
              <div class="input-group">
                <input v-model="newUnitName" placeholder="请输入单位名称" class="unit-input" maxlength="10" />
                  ...
                  <div class="unit-actions">
                    ...
                    >
                      <uni-icons
                        type="trash"
                        size="20"
                        :color="isDefaultUnit(unit.name) ? '#ccc' : '#ff4757'"
                      ></uni-icons>
                    </button>
                  </div>
                </div>
            ...
            <div class="modal-footer">
              <button @click="closeUnitManagement" class="footer-btn back-btn">返回</button>
            </div>
          </scroll-view>
        </div>
      </div>
    ...
    <!-- 版本信息弹窗 -->
    <div class="znj-modal-overlay" v-if="versionModalVisible" @click="closeVersionModal">
      <div class="znj-version-modal" @click.stop>
        <div class="znj-version-modal-header">
          <span>版本信息</span>
          <uni-icons
            custom-prefix="iconfont"
            type="icon-icon-cross-squre"
        ...
        <div class="znj-version-modal-body">
          <div class="version-info">
            <div class="version-item">
              <div class="version-label">应用名称</div>
              <div class="version-value">{{ appName }}</div>
            </div>
            <div class="version-item">
              <div class="version-label">当前版本</div>
              <div class="version-value version-number">v{{ versionName }}</div>
            </div>
            <div class="version-item">
              <div class="version-label">版本代码</div>
              <div class="version-value">{{ versionCode }}</div>
            </div>
            <div class="version-item">
              <div class="version-label">应用描述</div>
              <div class="version-value">{{ appDescription }}</div>
            </div>
          </div>
          <div class="modal-footer">
            <button @click="closeVersionModal" class="footer-btn confirm-btn">确定</button>
          </div>
        </div>
      </div>
    </div>
      ...
      uni.startBluetoothDevicesDiscovery({
        success(res) {
          ...
          uni.onBluetoothDeviceFound(function (devices) {
            ...
            const deviceExists = that.deviceList.some(device => device.deviceId === res.devices[0].deviceId)
