		...
		<div style="display: flex; width: 100%;">
			...
			<div style="flex: 1; background-color: #ffffff; text-align: right;">
				<div
					...
					<div style="font-size: 15rpx; font-weight: bold;">
						<button class="add-expense-btn">添加费用</button>
					</div>
				</div>
		...
		methods: {
			...
			calcCommodityaddedInboundAmount(commodityAdded) {
				if (commodityAdded.calcType === 2) {
					commodityAdded.inboundAmount = commodityAdded.initWeight * commodityAdded.incomingPrice
				}
				if (commodityAdded.calcType === 1) {
					commodityAdded.inboundAmount = commodityAdded.initMount * commodityAdded.incomingPrice
				}
			},
