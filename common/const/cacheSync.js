...
export const getCompanyId = () => {
	return uni.getStorageSync(config.storageCompanyId) || {}
}

export const setCompanyId = (userInfo) => {
	uni.setStorageSync(config.storageCompanyId, userInfo)
}

export const clearCompanyId = () => {
	uni.removeStorageSync(config.storageCompanyId)
}
