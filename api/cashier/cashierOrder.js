...
export default {
  ...
  GetAccountByCompanyIdandDateRange(companyId, startDate, endDate, pageSize, currentPage) {
    return http.get(
      `/Order/GetAccountByCompanyIdandDateRange?Id=${companyId}&startTime=${startDate}&endTime=${endDate}&pageSize=${pageSize}&currentPage=${currentPage}`
    )
  },
  ...
  updateShareNum(id) {
    return http.get(`/Account/updateShareNum?accountId=${id}`)
  },
}
