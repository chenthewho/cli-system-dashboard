        ...
        <scroll-view scroll-y="true" class="znj-add-good-modal-body">
          <view class="znj-add-good-form">
            ...
            <view class="znj-add-good-row">
              ...
              <div class="znj-add-good-switch-group">
                <button class="znj-add-good-switch-btn" :class="{ active: formData.isMultiLevel === 1 }" disabled>
                  是
                </button>
                <button class="znj-add-good-switch-btn" :class="{ active: formData.isMultiLevel === 0 }" disabled>
                  否
                </button>
              </div>
            </view>
            ...
            <view class="znj-add-good-row" v-if="formData.isMultiLevel === 1">
              ...
              <div class="znj-add-good-switch-group">
                <button class="znj-add-good-switch-btn" :class="{ active: formData.isShareStock === 1 }" disabled>
                  是
                </button>
                <button class="znj-add-good-switch-btn" :class="{ active: formData.isShareStock === 0 }" disabled>
                  否
                </button>
              </div>
            </view>
            ...
            <view class="znj-add-good-row" v-if="formData.isMultiLevel == 0">
              ...
              <view class="znj-add-good-btn-group">
                <button class="znj-add-good-type-btn" :class="{ active: formData.saleWay === 1 }" disabled>
                  按重量
                </button>
                <button class="znj-add-good-type-btn" :class="{ active: formData.saleWay === 2 }" disabled>
                  按件数
                </button>
                <button class="znj-add-good-type-btn" :class="{ active: formData.saleWay === 3 }" disabled>
                  按件拆包
                </button>
  ...
  methods: {
    ...
    loadEditData(data) {
      ...
      this.formData = {
        ...
        gradeList:
          data.gradeList && data.gradeList.length > 0
            ? JSON.parse(JSON.stringify(data.gradeList))
            : [
                {
                  packageType: '定装',
                  countUnit: '件',
