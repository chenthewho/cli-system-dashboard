  ...
  <div class="cashier-card">
    <div class="cashier-col">
      <div class="good-name">
        <div class="good-name-header">
          ...
          <u-icon
            ...
            color="#969696"
            size="30"
            @click="showAllweightStr = !showAllweightStr"
          ></u-icon>
        </div>
      </div>
      ...
      <div class="card-body" v-if="editingCard.saleWay === 1">
        ...
        <div v-if="showAllweightStr" class="allweight-display">总重：{{ editingCard.allweightSrt }}</div>

        <div class="input-row">
          <div
            :class="{ 'custom-input': true, 'input-focused': custominputFocused4, 'input-wrapper': true }"
          ...
          <div
            :class="{ 'custom-input': true, 'input-focused': custominputFocused2, 'input-wrapper': true }"
            @click="custominputFocusedMethod(2)"
          >
            <div class="input-label">单价</div>
            <div class="input-value-container">
              <input
                ref="input_referenceAmount"
                class="step1-input input-field"
                type="text"
                inputmode="none"
        ...
        <div class="input-row">
          ...
          >
            ...
            <div class="input-value-container">
              ...
              />
              <span class="currency-label"
                >元/{{ editingCard.commoditySpec ? editingCard.commoditySpec.specName : '' }}</span
              >
            </div>
          </div>
        </div>
...
/* 确定按钮特殊样式 - 使用绿色 */
.confirm-btn {
  background: $zn-main-purple-color !important;
  font-weight: bold;
}
