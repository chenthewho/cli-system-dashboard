<template>
  <div style="width: 220rpx; background-color: #ffffff; display: flex">
    <div>
      <div
        style="display: flex; margin-left: 5rpx; margin-top: 5rpx; line-height: 18rpx; align-items: center; gap: 5rpx"
      >
        <!-- 返回按钮 -->
        <button
          v-if="showBackButton"
      ...
      >
        <uni-icons
          ...
          size="30"
          color="#ffffff"
          style="margin-right: 5px; line-height: 30rpx"
        ></uni-icons
        >新增货品
      </div>
      ...
      <div>
        ...
        >
          <div style="display: flex; flex-direction: column; gap: 5rpx; background-color: #ddd; height: 100%">
              ...
              >
                <div>
                  ...
                  <div v-if="item.isMultiLevel == 0">
                    ...
                    >
                    <text
                      v-if="item.extralModel && item.extralModel.name"
                      style="
                        margin-top: 5rpx;
                        margin-left: 5rpx;
                        font-size: 10rpx;
    ...
    filteredCommodityList() {
      ...
      if (this.searchKeyword && this.searchKeyword.trim()) {
        ...
        filteredList = filteredList.filter(
          item => item.commodityName && item.commodityName.toLowerCase().includes(keyword)
        )
      }
        ...
        uni
          ...
          .boundingClientRect(data => {
            if (data && data.length > 0) {
              ...
              this.createMultiLevelView(data[0].left + data[0].width / 2, data[0].top, item, item.childrenList || [])
            } else {
