        ...
        <div class="left-input-section">
          ...
          <div class="amount-inputs-section">
            <div class="amount-inputs">
              ...
              <div
                class="input-row discount-row"
                :class="{ active: selectInputPay === 9 }"
                @click="handleEditingClick(9)"
              >
                <div class="discount-toggle">
                  <button class="discount-btn" :class="{ active: localAccountDiscount }" @click="handleSetDiscount">
                    优惠
                  </button>
                  <button class="discount-btn" :class="{ active: !localAccountDiscount }" @click="handleSetOvercharge">
                    多收
                  </button>
                </div>
              ...
              <div
                class="input-row"
                :class="{ active: selectInputPay === 2, 'flash-red-row': actualAmountFlash }"
                @click="handleEditingClick(2)"
              >
          ...
          <div class="payment-methods-section">
            ...
            <div class="payment-methods-grid" v-if="localAccountExpense">
              <div class="payment-method-card" :class="{ active: selectInputPay === 5 }" @click="handleEditingClick(5)">
              ...
              <div class="payment-method-card" :class="{ active: selectInputPay === 6 }" @click="handleEditingClick(6)">
                <div class="payment-method-card-content">
                  <div class="payment-icon">
              ...
              <div class="payment-method-card" :class="{ active: selectInputPay === 7 }" @click="handleEditingClick(7)">
                <div class="payment-method-card-content">
                  <div class="payment-icon">
              ...
              <div class="payment-method-card" :class="{ active: selectInputPay === 8 }" @click="handleEditingClick(8)">
                <div class="payment-method-card-content">
                  <div class="payment-icon">
        ...
        <div class="right-keypad-section">
          ...
          <div class="customer-info-section" :class="{ 'flash-red': customerInfoFlash }">
            <div
              ...
              :class="currentMember.debts > 0 ? 'debt' : 'normal'"
          ...
          <div class="action-buttons">
            <button class="action-btn debt-btn" @click="handleDebtAll" v-if="localPayAmount.actual >= 0">
              整单下欠
            </button>
            <button
              class="action-btn confirm-btn"
              :class="{ 'confirm-btn2': localPayAmount.actual < 0 }"
              @click="handleConfirm"
            >
              确认收款
            </button>
...
export default {
  ...
  methods: {
    ...
    handleDebtAll() {
      ...
      if (this.localAccountDiscount) {
        // 优惠模式：总额 - 优惠 - 收筐抵扣
        this.localPayAmount.debt = totalAmount - discountAmount - basketOffsetAmount
      } else {
        // 多收模式：总额 + 多收 - 收筐抵扣
        this.localPayAmount.debt = totalAmount + discountAmount - basketOffsetAmount
      }
    ...
    async handleConfirm() {
      ...
      // 如果是整单下欠（实付金额为0且下欠金额大于0），则跳过实付金额验证
      const isFullDebt = actualAmount === 0 && debtAmount > 0

      console.log('actualAmount', actualAmount)
      console.log('debtAmount', debtAmount)
      if (!isFullDebt && Math.abs(actualAmount - expectedActualAmount) > 0.01) {
